 ...
 */
function _manually_load_bt_downloads_plugin()
{
	require dirname(__DIR__) . '/bt-downloads/bt-downloads.php';
}

tests_add_filter('muplugins_loaded', '_manually_load_bt_downloads_plugin');
